...
4. Returns the list of generated files."
  ...
  (let* ((all-args (if (and args (not (keywordp (car args))))
         ...
         ;; Otherwise, if iduh-org-ssg-skeleton-directory is an absolute path, use its parent.
         ;; Fallback to default-directory.
         (project-root (expand-file-name 
                        (or base 
                            (and iduh-org-ssg-skeleton-directory 
                                 (file-name-absolute-p iduh-org-ssg-skeleton-directory)
                                 (file-name-directory (directory-file-name iduh-org-ssg-skeleton-directory)))
                            default-directory)))
